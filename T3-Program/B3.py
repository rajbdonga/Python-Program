...
# # accounting loss suggest that in a given data of numerical value the percentage of values starting with one is 30% and only 10% values start with 9 it is contrasting with is expectation where the value starting with 1 and 9 would be equaly like it find the percentage of the value starting with digit 1 true 9
